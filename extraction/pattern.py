...
KEY_PATTERN = re.compile('第[一二三123]名|第[一二三123]中标|第[一二三123]预中标候选(人|单位|名称)|第[一二三123]候选(人|单位|名称)')
...
FIRST_KEY_PATTERN = re.compile(
                            ...
                            "成交社会资本(名称|方|单位名称)|拟中标(单位|人|供应商)|第一候选(人|单位|名称)|(推荐)中标候选人|首选中标候选人")
...
MORE_KEY_PATTERN = re.compile(
                            ...
                            "成交社会资本(名称|方|单位名称)|拟?中标(单位|人|供应商|企业)|第一候选(人|单位|名称)|(推荐)中标候选人|中标人|"
...
valid_database = ['stang_bid_new', 'stang_cbid', 'stang_bid']

...
if __name__ == '__main__':
    ...
    # 测试id
    new_ids = [74782, 8783252, 10104898, 11254583, 11351661, 10126764, 11988509, 4924951, 4924792, 4924951, 4924960, 3880588, 3882099, 11835976, 10135746, 11513530, 10031940, 11656137, 10105547, 10125613, 1010414, 11408442,
